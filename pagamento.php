    ...
    <div class="container">
        ...
        <?php elseif ($resultado): ?>
            ...
            <div class="payment-options">
                <!-- Opção PIX -->
                <a href="pagamento_pix.php?codigo=<?= urlencode($resultado['codigo_inscricao']) ?>&data_nascimento=<?= urlencode($resultado['data_nascimento']) ?>" class="payment-option">
                    ...
                    <h3>Pix</h3>
                    <p>Pague instantaneamente com QR Code ou chave Pix.</p>
                </a>

                <!-- Opção Cartão de Crédito (Placeholder) -->
                <div class="payment-option" onclick="alert('Forma de pagamento Cartão de Crédito em desenvolvimento.')">
                    ...
                    <p>Pague com seu cartão de crédito (em breve).</p>
                </div>
                ...
                <div class="payment-option" onclick="alert('Forma de pagamento Boleto Bancário em desenvolvimento.')">
                    <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath fill='%23FF9800' d='M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z'/%3E%3C/svg%3E" alt="Boleto Bancário">
